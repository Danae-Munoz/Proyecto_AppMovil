...
export class InicioPage implements OnInit, AfterViewInit {
  ...
  public listaAnimaciones = [
    { id: 1, nombre: 'Traslación de derecha a izquierda' },
    { id: 2, nombre: 'Rotación en 360°' },
  ];

  public animacion = { id: 1, nombre: 'Traslación de derecha a izquierda' };
  ...
  public limpiar1(): void {
    ...
    this.animateItem1(this.itemEducacion.nativeElement, 400);
    this.animateItem1(this.itemFechaNacimiento.nativeElement, 500);
  }
  ...
  createPageTurnAnimation() {
    const animation = this.animationController
      ...
      .iterations(1)  // Para hacer la animación una sola vez, puedes cambiarlo a Infinity para repetirla
      .duration(1000) // Duración de 1 segundo, ajusta según tu necesidad
